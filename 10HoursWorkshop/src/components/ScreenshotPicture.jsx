...
const ScreenshotPicture = () => {
  ...
  return (
    <section ref={sectionRef}>
      <h1 className="smooth-scroll text-center text-xl  md:text-2xl lg:text-3xl font-bold p-4 mt-10">
      ...
      <section className="smooth-scroll  grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 justify-items-center">
